...
It means, to describe the brain (neurons, synapses, networks) by a nonlinear dynamical system, so that we can simulate our brain's activity (EEG etc.) on a computer, predict the future brain state that may be healthier or not, and keep it or control by making another state.
